...
int main() {
    ...
    // test 1 - add an item to the stack
    std::cout << "Test 1 - add one item to the stack" << std::endl;
    std::cout << "----------------------------------" << std::endl;
    ...
    // test 3 - get data off of the stack
    ...
    // test 4 - look at data on the stack
    std::cout << "Test 4 - look at data on the stack" << std::endl;
    std::cout << "----------------------------------" << std::endl;

    std::cout << stack.top().value_or(Data {-1, -1.0}) << std::endl;

    // test 5 - empty the stack
    std::cout << "Test 5 - empty the stack" << std::endl;
    std::cout << "------------------------" << std::endl;
